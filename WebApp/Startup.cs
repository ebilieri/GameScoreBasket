    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDefaultIdentity<IdentityUser>()
                .AddEntityFrameworkStores<GameScoreDBContext>();

            //services.AddDbContext<GameScoreDBContext>(options =>
            //    options.UseSqlServer(sqlConnection));

            //services.AddDbContext<GameScoreDBContext>(options =>
            //    options.UseSqlServer(sqlConnection, s => s.MigrationsAssembly("WebApp")));
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env)
        {
            ...
            app.UseMvc(routes =>
            {
                routes.MapRoute(
                    name: "default",
                    template: "{controller=Pontuacao}/{action=Index}/{id?}");
            });
        }
    }
}
